...
board.processMove(ChessMove("c7-c8"))	# Pawn moves to 8th row but does not promote
board.processMove(ChessMove("d2xc1"))	# Pawn captures on 8th row but does not promote
