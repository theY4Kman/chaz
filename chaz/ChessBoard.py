...
class ChessBoard:
	...
	def emptyPathTo(self, a, b):
		...
		isVertical = False
		isDiagonal = False
		if(not a.isOnBoard() or not b.isOnBoard()):return False
		if(a.rank == b.rank and a.file != b.file):isHorizontal = True
		elif(a.file == b.file and a.rank != b.rank):isVertical = True
		elif(a.file != b.file and a.rank != b.rank and abs(a.file - b.file) == abs(a.rank - b.rank)):isDiagonal = True
		else:return False
		if(isHorizontal):
